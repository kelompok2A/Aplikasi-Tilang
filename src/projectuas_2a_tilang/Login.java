...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/projectuas_2a_tilang_icon/Header login.jpg"))); // NOI18N
        ...
        btnLogin.setBackground(new java.awt.Color(167, 59, 223));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (username.isEmpty() || password.isEmpty()){
            JOptionPane.showMessageDialog(this, "Username / Kata Sandi tidak boleh kosong", "Error", JOptionPane.ERROR_MESSAGE);
        }else {
            //Mulai proses Login
    ...
    private void userLogin(String username, String password) {
       ...
       if(dbconn != null){
        try {
            ...
            if(res.next()){
                //Menampilkan dashboard atau halaman baru setelah login
                dispose();
                Dashboard_Frame d = new Dashboard_Frame();
                d.setTitle("Dashboard_Frame");
                d.setVisible(true);
            }else{
                System.out.println("username " + username);
                System.out.println("password " + password);
                JOptionPane.showMessageDialog(this, "Username / Kata Sandi tidak ditemukan", "Error", JOptionPane.ERROR_MESSAGE);   
            } 
