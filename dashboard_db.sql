...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=720542043ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="133">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tilangdb&table=users">`tilangdb`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dashboard_db&table=dashboard">`dashboard_db`.`dashboard`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=stockdb&table=tbluser">`stockdb`.`tbluser`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tilangdb&table=dashboard">`tilangdb`.`dashboard`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tilangdb&table=Users">`tilangdb`.`Users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tilang_db&table=register">`tilang_db`.`register`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tilang_db&table=penemu">`tilang_db`.`penemu`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="38773e46314154644c554f4a2b787e5a">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="133"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="tilangdb" targettable="dashboard">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `dashboard`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tilangdb" targettable="dashboard">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `dashboard`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="tilangdb" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            targetdb="dashboard_db" targettable="dashboard">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `dashboard_db`.`dashboard` ( `id` INT(100) NOT NULL AUTO_INCREMENT ,  `nama` TEXT NOT NULL ,  `kategori` VARCHAR(200) NOT NULL ,  `jumlah` INT(100) NOT NULL ,  `lokasi` VARCHAR(100) NOT NULL ,  `gambar` TEXT NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tilangdb" targettable="users">
                            <div class="action_content">
  ...
  `keterangan` varchar(500) NOT NULL
            ...
            Queried time
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="stockdb" targettable="tbluser">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbluser`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="stockdb" targettable="tbluser">
                            <div class="action_content">
